...
// 		Debug.Log("bNcAni " + re);
	...
	void Update()
	{
		...
		{
            m_fOffsetX += m_Timer.GetSmoothDeltaTime() * m_fScrollSpeedX * base.EffectTimeScale_;
            m_fOffsetY += m_Timer.GetSmoothDeltaTime() * m_fScrollSpeedY * base.EffectTimeScale_;
		} else {
            m_fOffsetX += m_Timer.GetDeltaTime() * m_fScrollSpeedX * base.EffectTimeScale_;
            m_fOffsetY += m_Timer.GetDeltaTime() * m_fScrollSpeedY * base.EffectTimeScale_;
		}

		bool bCallEndAni = false;
		if (m_bRepeat == false)
		{
            m_RepeatOffset.x	+= m_Timer.GetDeltaTime() * m_fScrollSpeedX * base.EffectTimeScale_;
            ...
            m_RepeatOffset.y += m_Timer.GetDeltaTime() * m_fScrollSpeedY * base.EffectTimeScale_;
