...
//			DrawDefaultInspector();
            ...
            if (m_Sel.m_TextureType == NcSpriteAnimation.TEXTURE_TYPE.TileTexture || m_Sel.m_TextureType == NcSpriteAnimation.TEXTURE_TYPE.MeshUv || m_Sel.m_TextureType == NcSpriteAnimation.TEXTURE_TYPE.MeshUvMirror)
			{
			...
			if (m_Sel.m_PlayMode != NcSpriteAnimation.PLAYMODE.RANDOM && m_Sel.m_PlayMode != NcSpriteAnimation.PLAYMODE.SELECT)
			{
                ...
                m_Sel.m_fFps				= EditorGUILayout.FloatField(GetHelpContent("m_fFps")			, m_Sel.FpsBase);
			}
